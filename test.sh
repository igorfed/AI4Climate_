...
#pth='/home/igofed/LiU/AI4Climate_version_updated/AI4Climate_/outputs/efficientnet_b1_weather_2_last_checkpoint.bin'
...
python3 src/inference.py --dataset $dataset --model $model --path $path --pth $pth --plot $plot #--split