...
#python3 src/inference.py --dataset $dataset --model $model --path $path --pth $pth --plot $plot 
#python3 src/inference_pretrained.py --dataset $dataset --model $model --path $path --pth $pth --plot $plot 
